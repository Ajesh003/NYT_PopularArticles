...
public class MPAModel {
	...
	public var media : Array<MPAMedia>?
...
*/
    public class func modelsFromDictionaryArray(array:NSArray) -> [MPAModel]
    {
        var models:[MPAModel] = []
        for item in array
        {
            models.append(MPAModel(dictionary: item as! NSDictionary)!)
        }
        return models
    }
...
*/
	required public init?(dictionary: NSDictionary) {
        ...
        if media is Array<Any> {
            self.media = MPAMedia.modelsFromDictionaryArray(array: dictionary["media"] as! NSArray)
        }
	}
