...
*/
    public class func modelsFromDictionaryArray(array:NSArray) -> [MPAMetaData]
    {
        var models:[MPAMetaData] = []
        for item in array
        {
            models.append(MPAMetaData(dictionary: item as! NSDictionary)!)
        }
        return models
    }
