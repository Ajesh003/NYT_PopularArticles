...
public class MPAMedia {
	public var type : String?
	public var subtype : String?
	public var caption : String?
	public var copyright : String?
	public var approved_for_syndication : Int?
	public var media_metadata : Array<MPAMetaData>?
...
*/
    public class func modelsFromDictionaryArray(array:NSArray) -> [MPAMedia]
    {
        var models:[MPAMedia] = []
        for item in array
        {
            models.append(MPAMedia(dictionary: item as! NSDictionary)!)
        }
        return models
    }
...
*/
	required public init?(dictionary: NSDictionary) {
		...
		if (dictionary["media-metadata"] != nil) { media_metadata = MPAMetaData.modelsFromDictionaryArray(array: dictionary["media-metadata"] as! NSArray) }
	}
